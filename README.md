...
|---|---|---|
| `VITE_LOUPE_ZOOM` | `2.5` | Magnification factor (e.g. `3` for 3× zoom) |
| `VITE_LOUPE_SIZE` | `220` | Lens diameter in pixels |

Set these in a `frontend/.env.local` file (Vite loads it automatically):
